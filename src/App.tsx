...
const brands = [
  {
    ...
    highlights: ['Mais conforto em visão de perto, intermediária e longe', 'Design personalizado para reduzir distorções', 'Ideal para quem busca adaptação rápida em multifocais']
  },
  {
    name: 'Kodak Lens',
    summary:
      'Lentes com tradição em nitidez e fidelidade de cores, aliando tratamentos resistentes e proteção diária.',
    highlights: ['Tratamentos antirreflexo e antirriscos confiáveis', 'Excelente equilíbrio entre qualidade óptica e custo', 'Alta definição de contraste para dirigir e trabalhar']
  },
  {
    name: 'Prime',
    summary:
      'Lentes confortáveis com ótimo custo-benefício, pensadas para quem busca desempenho diário sem abrir mão de estilo.',
    highlights: ['Opções para diferentes graus e estilos de armação', 'Boa performance em ambientes internos e externos', 'Disponível em materiais leves para uso prolongado']
  },
  {
    name: 'Optview',
    summary:
      'Soluções digitais personalizadas que valorizam a ergonomia visual e a estabilidade da imagem.',
    highlights: ['Mapeamento preciso para centragem avançada', 'Versatilidade para óculos de uso contínuo', 'Nitidez estável em telas e leitura']
  },
  {
    name: 'Zeiss',
    summary:
      'Precisão alemã reconhecida no mundo todo, com proteção completa contra raios UV e excelente controle de aberrações.',
    highlights: ['Campo de visão amplo e bem equilibrado', 'Revestimentos premium para maior durabilidade', 'Nitidez constante em diferentes condições de luz']
  },
  {
    name: 'Hoya',
    summary:
      'Lentes leves e resistentes, conhecidas por tratamentos modernos que facilitam a rotina e reduzem cansaço visual.',
    highlights: ['Tecnologias anti-embaçamento e antirreflexo', 'Materiais finos que valorizam o conforto', 'Ótimo desempenho para quem usa telas por longos períodos']
  }
];
  ...
  <section id={id} className={clsx('py-16 sm:py-20', className)}>
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 sm:px-10">
      <div className="max-w-3xl space-y-3">
        <p className="text-sm font-semibold uppercase tracking-wide text-brand-600">Ótica Du & Edu</p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-slate-100">
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 sm:px-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-brand-600">Ótica Du & Edu</p>
              <p className="text-xs text-slate-500">Visão clara com cuidado pessoal</p>
            </div>
          </div>
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 py-16 sm:px-10 sm:py-20 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl font-bold leading-tight text-slate-900 sm:text-5xl">
                Enxergue o melhor da vida com a atenção da Ótica Du & Edu
              </h1>
              <p className="text-lg text-slate-600">
                Ajudamos você a escolher as lentes e armações ideais para o seu estilo e a sua rotina. Trabalhamos com
                marcas líderes e orientação completa para que cada detalhe da sua receita seja respeitado.
              </p>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                {stats.map((stat) => (
                  <div key={stat.label} className="rounded-2xl bg-white/80 p-4 shadow-sm ring-1 ring-slate-200">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative grid gap-4 rounded-3xl bg-white p-6 shadow-xl ring-1 ring-slate-200 sm:grid-cols-2">
                <div className="space-y-3 rounded-2xl bg-gradient-to-br from-brand-600 to-brand-800 p-4 text-white shadow-lg">
                  ...
                  <p className="text-lg font-bold">Rua Almirante Barroso, 45, sala 3</p>
                  <p className="text-sm">Vila Nova, Blumenau • CEP 89035-402</p>
                </div>
                <div className="space-y-3 rounded-2xl border border-slate-200 p-4 text-slate-700 shadow-sm">
                  <p className="text-sm font-semibold text-brand-700">Horário e contato</p>
                  <p className="text-sm">Segunda a sexta, 9h às 18h</p>
                  <p className="text-sm">Sábado, 9h às 13h</p>
                  <p className="text-sm">Fale com a gente e descubra a melhor solução para seus olhos.</p>
                </div>
                <div className="col-span-2 rounded-2xl border border-dashed border-brand-200 p-4 text-sm text-slate-600">
                  Há 15 anos ajudando pessoas a enxergarem com conforto, segurança e estilo. Cada ajuste é feito com
                  cuidado artesanal para que você saia da loja enxergando melhor e se sentindo incrível.
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            <div className="space-y-4 rounded-3xl bg-white p-6 shadow-lg ring-1 ring-slate-200">
              <h3 className="text-xl font-semibold text-brand-700">Cuidado que atravessa gerações</h3>
              <p className="text-base text-slate-700">
                Construímos uma relação próxima com nossos clientes: entendemos hábitos, orientamos sobre lentes e
                acompanhamos cada etapa até a adaptação. Nosso compromisso é que você saia seguro sobre sua escolha e
                volte sempre que precisar de manutenção ou novos óculos.
              </p>
              <p className="text-base text-slate-700">
                Localizados na Rua Almirante Barroso, Nº 45, sala 3, no bairro Vila Nova, oferecemos um ambiente acolhedor
                e equipe treinada para traduzir sua receita em um par de óculos confortável e bonito.
              </p>
            </div>
            <div className="grid gap-4 rounded-3xl bg-gradient-to-br from-brand-50 via-white to-brand-100 p-6 ring-1 ring-brand-100">
              <div className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
                <p className="text-sm font-semibold text-brand-700">Diversidade para todos os gostos</p>
                <p className="text-base text-slate-700">
                  Armações clássicas, esportivas e autorais para combinar com diferentes estilos. Ajustamos medidas e
                  encaixe para que a armação respeite seu formato de rosto e sua rotina.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
                <p className="text-sm font-semibold text-brand-700">Atenção a cada detalhe</p>
                <p className="text-base text-slate-700">
                  Conferimos centragem, espessura, tratamentos e acabamentos para garantir conforto, durabilidade e a
            ...
            {brands.map((brand) => (
              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-gradient-to-br from-brand-500 to-brand-700 text-center text-lg font-bold text-white shadow-md">
                      {brand.name[0]}
                    </div>
                    <h3 className="text-xl font-semibold text-slate-900">{brand.name}</h3>
                  </div>
                  <p className="text-sm text-slate-700">{brand.summary}</p>
                  <ul className="space-y-2 text-sm text-slate-700">
                    {brand.highlights.map((item) => (
                      <li key={item} className="flex items-start gap-2">
                        <span className="mt-1 inline-block h-2 w-2 rounded-full bg-brand-500" aria-hidden />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                <div className="mt-4 text-xs font-semibold uppercase tracking-wide text-brand-700">Soluções personalizadas</div>
              </div>
            ))}
          </div>
        </Section>
        ...
        >
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {prescriptionItems.map((item) => (
              <div key={item.title} className="rounded-3xl bg-white p-6 shadow-md ring-1 ring-slate-200">
        ...
        >
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="rounded-3xl bg-white p-6 shadow-md ring-1 ring-slate-200">
              <h3 className="text-lg font-semibold text-brand-700">Visite a loja</h3>
              <p className="mt-2 text-sm text-slate-700">Rua Almirante Barroso, Nº 45, sala 3, Vila Nova, Blumenau</p>
            ...
            <div className="rounded-3xl bg-gradient-to-br from-brand-600 to-brand-800 p-6 text-white shadow-lg">
              ...
              <p className="mt-2 text-sm text-white/90">
                Conte suas necessidades visuais, uso de telas e atividades. Assim indicamos a lente ideal e ajudamos a
      ...
      <footer className="border-t border-slate-200 bg-white py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-4 px-6 sm:flex-row sm:items-center sm:px-10">
          <div>
            <p className="text-sm font-semibold text-brand-700">Ótica Du & Edu</p>
            <p className="text-xs text-slate-600">Visão clara, atendimento humano e marcas que você confia.</p>
          </div>
          <div className="text-xs text-slate-500">Rua Almirante Barroso, 45, sala 3 • Vila Nova • Blumenau</div>
        </div>
      </footer>
    </div>
  );
